...
const NARAK_QUIZ_QUESTIONS = [
  ...
  { question: "대한민국의 한글날은 몇 월 며칠? (예: 109)", answer: "109" },
  ...
  { question: "명량해전에서 이순신 장군이 승리한 연도는? (숫자만)", answer: "1597" },
  { question: "임진왜란이 발발한 연도는? (숫자만)", answer: "1592" },
  { question: "병자호란이 발발한 연도는? (숫자만)", answer: "1636" },
  { question: "갑오개혁이 일어난 연도는? (숫자만)", answer: "1894" },
  { question: "을사늑약이 체결된 연도는? (숫자만)", answer: "1905" },
  { question: "국권을 빼앗긴 경술국치가 일어난 연도는? (숫자만)", answer: "1910" },
  { question: "대한민국 정부가 수립된 연도는? (숫자만)", answer: "1948" },
  { question: "4·19 혁명이 일어난 연도는? (숫자만)", answer: "1960" },
  { question: "5·18 민주화운동이 일어난 연도는? (숫자만)", answer: "1980" },
  { question: "6월 민주항쟁이 일어난 연도는? (숫자만)", answer: "1987" },
